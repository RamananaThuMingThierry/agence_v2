  ...
  return (
    <section id="all-tours" className="bg-stone-50 py-20">
      <div className="mx-auto max-w-7xl px-4">
        <SectionTitle
          eyebrow="Liste complete des circuits"
          title="Tous les voyages disponibles"
          text="Cette section permet au client de comparer rapidement les circuits selon la duree, la destination, le type de voyage et le prix."
        />
        <div className="mt-12 overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm">
          <div className="hidden grid-cols-12 gap-4 bg-emerald-900 px-6 py-4 text-sm font-bold text-white md:grid">
            <div className="col-span-4">Circuit</div>
            <div className="col-span-2">Duree</div>
            <div className="col-span-2">Style</div>
            <div className="col-span-2">Depart</div>
