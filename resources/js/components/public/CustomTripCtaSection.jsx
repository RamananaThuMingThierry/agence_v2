...
export default function CustomTripCtaSection({ trips }) {
  ...
  return (
    <section className="px-4 py-16 text-white sm:py-20">
      <div className="mx-auto grid max-w-6xl gap-8 rounded-[2rem] bg-[linear-gradient(135deg,var(--accent-dark),var(--accent-deep))] px-5 py-8 shadow-[0_26px_70px_rgba(72,33,24,0.24)] sm:px-7 sm:py-10 md:grid-cols-2 md:items-center md:gap-10 md:px-10 md:py-12">
        <div>
          ...
          <p className="mb-6 max-w-xl text-sm leading-7 text-white/80 sm:text-base">{t("public.home.custom_trip.text")}</p>
